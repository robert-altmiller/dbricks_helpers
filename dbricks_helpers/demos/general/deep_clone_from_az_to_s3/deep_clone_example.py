...
spark.sql("""
  ...
  DEEP CLONE ******eastus.default.baggage
""")
...
# MAGIC %sql
# MAGIC
# MAGIC DESCRIBE HISTORY ******eastus.default.baggage;
# MAGIC
...
spark.sql('DESCRIBE DETAIL ******eastus.default.baggage').collect()[0].location
...
src_path = f"/mnt/******eastus/{spark.sql('DESCRIBE DETAIL ******eastus.default.baggage').collect()[0].location.split('.net/')[1]}"
