...
df_workspaces_exploded.write \
  ...
  .mode("overwrite") \
  .saveAsTable("catalog.datamesh_iam_schema.all_workspace_and_catalog_perms")

df_workspaces_admins.write \
  .format("delta") \
  .option("overwriteSchema", "true") \
  .mode("overwrite") \
  .saveAsTable("catalog.datamesh_iam_schema.all_workspace_and_catalog_perms_admins")

df_workspaces_users.write \
  .format("delta") \
  .option("overwriteSchema", "true") \
  .mode("overwrite") \
  .saveAsTable("catalog.datamesh_iam_schema.all_workspace_and_catalog_perms_users")